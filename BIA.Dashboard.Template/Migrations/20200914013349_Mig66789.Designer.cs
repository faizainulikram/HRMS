...
namespace BIA.Dashboard.Template.Migrations
{
    ...
    [Migration("20200914013349_Mig66789")]
    partial class Mig66789
    {
            ...
            modelBuilder.Entity("BIA.Dashboard.Template.Models.EducationDetail", b =>
                {
                    ...
                    b.Property<int?>("PersonnelInformationUserPersonnelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PersonnelInformationUserPersonnelId");
            ...
            modelBuilder.Entity("BIA.Dashboard.Template.Models.EducationDetail", b =>
                {
                    ...
                    b.HasOne("BIA.Dashboard.Template.Models.PersonnelInformationUser", null)
                        .WithMany("EducationDetail")
                        .HasForeignKey("PersonnelInformationUserPersonnelId");
                });
