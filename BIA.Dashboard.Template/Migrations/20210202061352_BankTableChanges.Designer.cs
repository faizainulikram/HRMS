...
namespace BIA.Dashboard.Template.Migrations
{
    ...
    [Migration("20210202061352_BankTableChanges")]
    partial class BankTableChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BIA.Dashboard.Template.Models.BankAccountPayrollAdvice", b =>
                {
            ...
            modelBuilder.Entity("BIA.Dashboard.Template.Models.PayrollBank", b =>
                {
                    b.Property<int>("PayrollBankId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BIA.Dashboard.Template.Models.PersonnelInformationAuditLog", b =>
                {
                    ...
                    b.Property<string>("FormattedStatusDate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BIA.Dashboard.Template.Models.PayrollBankBranch", b =>
                {
                    b.HasOne("BIA.Dashboard.Template.Models.PayrollBank", "PayrollBank")
                        .WithMany()
                        .HasForeignKey("PayrollBankId");
                });
