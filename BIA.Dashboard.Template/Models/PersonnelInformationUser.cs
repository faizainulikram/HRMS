...
namespace BIA.Dashboard.Template.Models
{
    ...
    public class PersonnelInformationUser
    {
        public PersonnelInformationUser()
        {
            this.EducationDetailUser = new List<EducationDetailUser>();
            this.ProfessionalQualificationUser = new List<ProfessionalQualificationUser>();
            this.EmergencyContactUser = new List<EmergencyContactUser>();
            this.FamilyInformationUser = new List<FamilyInformationUser>();
        }
        ...
        public ICollection<EducationDetailUser> EducationDetailUser { get; set; }

        //professional qualification (One2Many)
        public ICollection<ProfessionalQualificationUser> ProfessionalQualificationUser { get; set; }

        //family information (One2Many)
        public ICollection<FamilyInformationUser> FamilyInformationUser { get; set; }

        //emergency contact (One2Many)
        public ICollection<EmergencyContactUser> EmergencyContactUser { get; set; }
