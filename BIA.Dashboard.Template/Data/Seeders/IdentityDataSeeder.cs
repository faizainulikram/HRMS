...
{
    public static class IdentityDataSeeder<TApplicationUser, TIdentityRole>
        ...
        where TIdentityRole : IdentityRole, new()
    {
        ...
        private const string DefaultAdminUserEmail = "admin@bia.com.bn";
        ...
        private static async Task<TApplicationUser> CreateDefaultAdminUser(UserManager<TApplicationUser> userManager)
        {
            var user = await userManager.FindByEmailAsync("admin@bia.com.bn");
            if (user == null)
            {
                user = new TApplicationUser
                {
        ...
        public static async Task SeedDataAsync(IServiceProvider services, ILogger logger)
        {
            ...
            var userManager = services.GetRequiredService<UserManager<TApplicationUser>>();
